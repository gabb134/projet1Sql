...
namespace Projet1BaseDeDonnee3
{
    public partial class frmGestionReservationChambre : Form
    {
        ...
        {
            if (Convert.ToDateTime(reservationChambreDataGridView.CurrentRow.Cells[3].Value.ToString()) >= DateTime.Now)
            {
            ...
            {
                MessageBox.Show("Vous ne pouvez supprimer une réservation de chambre dont la date de début du séjour est antérieure à la date actuelle", "Erreur", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
